...
Users enter a table number between 1 and 50. When the lookup button is clicked or the enter key is pressed, the application searches a predefined set of questions and displays the matching topic and prompt.

If the input is empty or outside the valid range, an error message is shown asking for a valid table number.
...
5. Input validation with helpful error messaging  

## Screenshot

<img width="1917" height="850" alt="Screenshot 2026-06-29 000921" src="https://github.com/user-attachments/assets/f035a6ae-63d6-4452-a815-869dac0855f2" />
